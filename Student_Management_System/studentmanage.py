...
The connect()  function accepts connection credentials and returns an object of type SQLITE for database connection. 
The mysql.cursor() is used to communicate with the SQLite. connector.execute() will create the table in the database if it doesn’t exist.
'''
